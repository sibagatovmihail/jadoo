(() => {
    ...
    const booking = document.getElementById("tippy-booking");
    modules_flsModules.tippy = tippy_esm("[data-tippy-content]", {
        content: booking.innerHTML,
        allowHTML: true,
        interactive: true,
        arrow: false
    });
    ...
    function initSliders() {
        if (document.querySelector(".testimonials__slider.swiper")) new core(".testimonials__slider.swiper", {
            ...
            autoHeight: true,
            pagination: {
                el: ".testimonials__dotts.swiper-pagination",
                clickable: true
            },
            navigation: {
        ...
        if (document.querySelector(".clients__slider.swiper")) new core(".clients__slider.swiper", {
